...
/>
  ...
  {/* Technodrome Logo (below the main one) */}
  <img
      ...
      <div className="text-center md:text-left text-white/80">
        ...
        <div className="space-y-6 text-base sm:text-lg">
          <div>
            ...
            <p className="font-roboto-numbers text-sm">C112, 1st Floor, Eastern Business District, LBS Marg, Bhandup West, Mumbai, Maharashtra 400078</p>
          </div>

          <div>
            <p className="font-bold text-white">Registered Office:</p>
            <p className="font-roboto-numbers text-sm">3D, 1401, Dreams, LBS Marg, Bhandup West, Mumbai, Maharashtra 400078, India</p>
          </div>
